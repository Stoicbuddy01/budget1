...
const AddTransactionForm = ({ 
  ...
  const onSubmit = async (data) => {
    ...
    if (editMode) {
      // Pass the editId to updateTransaction
  ...
  useEffect(() => {
    if (transactionResult?.success && !transactionLoading) {
      console.log("Transaction created/updated successfully, redirecting..."); // Debugging
      ...
      console.error("Transaction creation/update failed:", transactionResult); // Debugging
      toast.error(`Failed to ${editMode ? "update" : "create"} transaction`);
    }
      ...
      >
        ...
        <div className="flex gap-10 justify-center">
          <Button
            type="button"
            variant="outline"
            className="w-60 h-8 text-sm" // Smaller button
            onClick={() => router.back()}
          >
            Cancel
          </Button>
